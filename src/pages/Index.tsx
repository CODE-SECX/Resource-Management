          ...
          <div className="p-6 border-b border-border bg-muted/40 mt-10 lg:mt-0">
            <div className="flex items-center justify-between mb-4">
              ...
              <button
                ...
                className="lg:hidden p-2.5 rounded-xl bg-secondary hover:bg-accent text-secondary-foreground hover:text-accent-foreground transition-all duration-200 border border-border relative z-50"
        ...
        <div className="flex-1 lg:ml-0 min-w-0">
          <div className="max-w-full px-4 sm:px-6 lg:px-8 py-8">
            ...
            <PageHeader
              ...
              subtitle="Discover and explore your curated learning materials"
              actions={
